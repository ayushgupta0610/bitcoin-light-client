...
//         BitcoinUtils.BlockHeader memory header = lightClient.getBlockHeader(VALID_BLOCK_HASH);
...
//         bytes32 reversed = BitcoinUtils.reverseBytes32(original);
//         assertNotEq(original, reversed);
//         assertEq(BitcoinUtils.reverseBytes32(reversed), original);
//     }
